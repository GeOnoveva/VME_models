...
# Inputs
```{r}
resp <- read.csv(file.path(savepath, "resp.csv"))

load("G:/R_projects/VH_MarVid/code/VME_models/Intermediate_objects/1_Predictors_out.RData")
...
resp <- resp %>% filter(sample_no%in%resp_spat@data$sample_no)
```

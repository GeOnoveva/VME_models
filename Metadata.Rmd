...
(1) a model was trained using observed density extracted from video and various environmental layers (including geology, oceanography, and bathymetry) as predictors
(2) the model was then used for predicting density of VME indicators throughout the entire coverage area, as well as the 67% prediction interval which is a good estimate for the prediction error
(2) Both raster datasets thus generated (predicted density, and error) where binned into two categories, and then combined as follows: high density with low error, high density with high error, and low density irrespective of error

...
(2) Taxonary (on HI onedrive folder, or use copy from Data folder) (3) e
...
removesp <- ""
#removesp <- c("Craniella polyura", "Axinellidae")
...
```{r}
rm(resp1, resp2)
write.csv(resp, file.path(savepath, paste(vme, "minus", paste(remove, collapse=", "), "resp.csv", collapse=" ")))
```
